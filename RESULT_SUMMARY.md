...
|---|---:|---:|---:|---|
| Card transactions | FAIL | 1,952,871 | 3.69% | A one-sided amount threshold reaches F1 0.718; ID-only PR-AUC is also high. |
...
The reference model scores do not rehabilitate the AI Hub FDS dataset. The same
outcome can be largely explained by exposed amount and code shortcuts, weak
split handling, entity artifacts, and unrealistically discrete monetary fields.
