...
| T1.3 Best one-sided amount threshold | PASS | 0.02589 | >= 0.7 | Best threshold rule: intended_balcon_amount: amount <= 0.0538092. |
...
| T4.2 Entity-holdout degradation | PASS | 1.038 | > 0.75 | Compares entity-holdout no-ID average precision to provided-split no-ID average precision. |
...
| T7 Temporal split degradation | PASS | 1.275 | > 0.75 | Compares temporal no-ID average precision to provided-split no-ID average precision. |
...
- provided_split_no_id_nb: ROC-AUC 0.8458, PR-AUC 0.1356, Top 1% P=23.37%, R=16.64%
- provided_split_id_only_nb: ROC-AUC 0.5, PR-AUC 0.01383, Top 1% P=1.32%, R=0.94%
- provided_split_with_id_nb: ROC-AUC 0.8458, PR-AUC 0.1356, Top 1% P=23.37%, R=16.64%
- provided_split_amount_only_nb: ROC-AUC 0.5939, PR-AUC 0.01812, Top 1% P=2.24%, R=1.60%
- temporal_holdout_no_id_nb: ROC-AUC 0.8679, PR-AUC 0.173, Top 1% P=28.82%, R=19.54%
- temporal_holdout_amount_only_nb: ROC-AUC 0.573, PR-AUC 0.01768, Top 1% P=1.24%, R=0.84%
- entity_holdout_no_id_nb: ROC-AUC 0.8719, PR-AUC 0.1408, Top 1% P=21.49%, R=19.14%
- entity_holdout_id_only_nb: ROC-AUC 0.5, PR-AUC 0.01041, Top 1% P=1.15%, R=1.03%
