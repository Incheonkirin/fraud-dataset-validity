...
- Duplicate rows excluding label and IDs: 1,081
...
| T1.2 Amount-only share of no-ID PR-AUC | PASS | 0.01323 | >= 0.8 | Compares amount-only average precision to the no-ID baseline. This dependency-free ratio is screening-only; confirm it with the optional LightGBM sensitivity model. |
...
| T4.1 ID-only baseline | PASS | {'ap_ratio': 0.004646119331773615, 'ap_lift': 1.0} | ratio/lift below warning pair | Compares ID-only AP to no-ID AP and fraud prevalence. |
...
| T6.1 Duplicate feature rows | PASS | 0.003796 | < 0.01 | Duplicate rows excluding labels and configured IDs: 1,081. |
| T6.2 Label conflicts for identical features | PASS | 0 | = 0.0 | Rows in identical non-ID feature groups with mixed labels: 0. |
| T7 Temporal split degradation | PASS | {'ap_lift_ratio': 1.3735546661567333, 'raw_ap_ratio': 1.6375250863713482, 'provided_prevalence': 0.0012640005617780275, 'temporal_prevalence': 0.0015069168196199141} | > 0.75 | Compares prevalence-normalized AP-lift on temporal holdout against the provided split. |
...
- provided_split_no_id_nb: ROC-AUC 0.9656, PR-AUC 0.2721, Best F1 0.4493, Top 1% P=10.07%, R=79.63%
- provided_split_id_only_nb: ROC-AUC 0.5, PR-AUC 0.001264, Best F1 0.002525, Top 1% P=0.12%, R=0.93%
- provided_split_with_id_nb: ROC-AUC 0.9656, PR-AUC 0.2721, Best F1 0.4493, Top 1% P=10.07%, R=79.63%
- provided_split_amount_only_nb: ROC-AUC 0.7196, PR-AUC 0.003598, Best F1 0.01986, Top 1% P=1.17%, R=9.26%
- provided_split_amount_threshold: `Amount` amount <= 0, train F1 0.02042, validation F1 0.03249
- temporal_holdout_no_id_nb: ROC-AUC 0.9715, PR-AUC 0.4455, Best F1 0.5116, Top 1% P=12.36%, R=81.99%
- temporal_holdout_amount_only_nb: ROC-AUC 0.6728, PR-AUC 0.003509, Best F1 0.01846, Top 1% P=0.86%, R=5.69%
