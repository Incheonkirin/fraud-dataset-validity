...
| T1.3 Best one-sided amount threshold | PASS | {'f1': 0.02330599913681485, 'f1_ratio': 0.05186727258879383} | F1 >= 0.7 and ratio >= 0.8 | Best threshold rule: Amount: amount <= 0; ratio compares against the no-ID baseline's best score-threshold F1. |
